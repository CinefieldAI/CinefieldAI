...
const navigationMenuTriggerStyle = cva(
  "inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-[9px] px-2 py-1 text-[14px] font-medium leading-5 tracking-[-0.1px] text-white [font-family:Inter,ui-sans-serif,system-ui,sans-serif] transition-colors hover:bg-white/5 hover:text-white focus:bg-white/5 focus:text-white focus:outline-none data-[state=open]:text-[#D97757] disabled:pointer-events-none disabled:opacity-50",
);
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex flex-row items-center gap-1 whitespace-nowrap rounded-[9px] px-2 py-1 text-[14px] font-medium leading-5 tracking-[-0.1px] text-white [font-family:Inter,ui-sans-serif,system-ui,sans-serif] outline-none transition-colors hover:bg-white/5 hover:text-white focus:bg-white/5 focus:text-white",
        className,
      )}
      {...props}
    />
