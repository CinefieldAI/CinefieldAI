...
export default function VideoMegaDropdown({
  ...
  return (
    <div
      className="w-[800px] max-w-[calc(100vw-24px)] max-h-[calc(100vh-70px)] overflow-x-hidden overflow-y-auto rounded-[16px] border border-white/[0.08] p-3 shadow-[0_18px_60px_rgba(0,0,0,0.45)] backdrop-blur-[24px] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      style={{
