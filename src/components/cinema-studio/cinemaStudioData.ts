  ...
  },
  {
    ...
    models: [
      ...
      vparent(
        ...
        "/Kling_3.0.png",
        [
          vsub("kling-3.0", "Kling 3.0", "4K", "3s-15s"),
          vsub("kling-3.0-turbo", "Kling 3.0 Turbo", "1080p", "3s-15s", ["NEW"]),
          vsub("kling-3.0-omni", "Kling 3.0 Omni", "4K", "3s-15s", ["PREMIUM", "EXCLUSIVE"]),
          vsub("kling-3.0-mini", "Kling 3.0 Mini", "720p", "3s-15s", ["EXCLUSIVE"]),
          vsub("kling-3.0-omni-edit", "Kling 3.0 Omni Edit", "720p", "3s-15s", ["EXCLUSIVE"]),
          vsub("kling-2.6", "Kling 2.6", "1080p", "5s-10s"),
          vsub("kling-2.6-max", "Kling 2.6 Max", "1080p", "5s-10s", ["PREMIUM"]),
          vsub("kling-01-video", "Kling 01 Video", "1080p", "5s-10s", ["PREMIUM"]),
        ],
      ),
      vparent(
        "openai-sora",
        ...
        "/Sora_2.png",
        [
          vsub("sora-2", "Sora 2", "720p", "6s-10s", ["PREMIUM"]),
          vsub("sora-3.1-lite", "Sora 3.1 Lite", "720p", "6s-10s", ["NEW"]),
          vsub("sora-2-pro", "Sora 2 Pro", "1080p", "6s-10s", ["PREMIUM"]),
          vsub("sora-2-3.1-fast", "Sora 2 3.1 Fast", "1080p", "6s-10s", ["PREMIUM"]),
          vsub("sora-2-max", "Sora 2 Max", "1080p", "6s-10s", ["PREMIUM"]),
          vsub("sora-2-pro-max", "Sora 2 Pro Max", "1080p", "6s-10s", ["PREMIUM"]),
        ],
      ),
      vparent(
        "google-veo",
