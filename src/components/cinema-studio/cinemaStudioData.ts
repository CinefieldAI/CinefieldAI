...
const IM = {
  ...
  soul2: M("higgsfield-soul-2", "Cinefield Soul 2.0", "Next generation ultra-realistic fashion visuals", Sparkles, { badge: "TOP" }),
  soulCinema: M("higgsfield-soul-cinema", "Cinefield Soul Cinema", "Cinema-grade visual creation", Sparkles),
  gpt2: M("gpt-image-2", "GPT Image 2", "4K images with near-perfect text rendering", OpenAIIcon, { resolution: "4K", badge: "NEW" }),
  seedream45: M("seedream-4-5", "Seedream 4.5", "ByteDance's next-gen 4K image-editing model", SeedreamIcon, { resolution: "4K", badge: "PREMIUM", isAdded: true }),
  ...
  nano2: M("nano-banana-2", "Nano Banana 2", "Pro quality at Flash speed", GoogleIcon, { badge: "PREMIUM" }),
  nano2lite: M("nano-banana-2-lite", "Nano Banana 2 Lite", "Lightweight image generation at speed", GoogleIcon, { badge: "NEW", isAdded: true }),
  ...
  soul: M("higgsfield-soul", "Cinefield Soul", "Ultra-realistic fashion visuals", Sparkles, { isAdded: true }),
  ...
  gpt: M("gpt-image", "GPT Image", "Versatile text-to-image AI", OpenAIIcon, { isAdded: true }),
  nano: M("nano-banana", "Nano Banana", "Google's standard generation model", GoogleIcon, { isAdded: true }),
  seedream5lite: M("seedream-5-lite", "Seedream 5.0 lite", "Intelligent visual reasoning", SeedreamIcon),
  seedream4: M("seedream-4-0", "Seedream 4.0", "ByteDance's advanced image editing model", SeedreamIcon, { isAdded: true }),
  grok: M("grok-imagine-image", "Grok Imagine", "Versatile image styles by xAI", GrokIcon, { badge: "PREMIUM" }),
  recraftUtil: M("recraft-utility", "Recraft V4.1 Utility", "Simple scenes with flat, even lighting", RecraftIcon, { badge: "NEW", isAdded: true }),
  ...
  flux2flex: M("flux-2-flex", "FLUX.2 Flex", "Edit with accuracy", FluxIcon, { isAdded: true }),
  flux2max: M("flux-2-max", "FLUX.2 MAX", "Sharp text, maximum detail", FluxIcon, { resolution: "4K", isAdded: true }),
  reve: M("reve", "Reve", "Advanced editing model", Wand2),
  fluxKontext: M("flux-kontext-max", "Flux Kontext Max", "Edit with accuracy", FluxIcon, { isAdded: true }),
  multiRef: M("multi-reference", "Multi Reference", "Multiple edits in one shot", MultiReferenceIcon, { isAdded: true }),
  wan22: M("wan-2-2", "WAN 2.2", "High-fidelity cinematic visuals", Sparkle, { isAdded: true }),
  marketingImage: M("marketing-studio-image", "Marketing Studio Image", "Model built for marketing usecase", Sparkles, { badge: "NEW" }),
  grok2: M("grok-imagine-2", "Grok Imagine 2.0", "High-resolution image generation by xAI", GrokIcon),
} as const;

export const IMAGE_MODEL_CATEGORIES: ModelCategory[] = [
  {
    label: "Cinematic models",
    models: [IM.aiCast, IM.locations, IM.soulCinema],
  },
  {
    label: "Featured models",
    models: [
  ...
  },
  {
    ...
    models: [
      ...
      IM.wan22,
      IM.cameras,
      // Not on the reference; ours, kept at the end so the order above stays
      // exactly as the reference lists it.
      IM.faceSwap,
      IM.characterSwap,
    ],
  },
