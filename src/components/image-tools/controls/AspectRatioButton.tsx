...
export default function AspectRatioButton({
  value,
  onChange,
  options,
    ...
    <Popover.Root open={open} onOpenChange={setOpen}>
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          align="center"
          sideOffset={6}
          className="z-[100000] w-32 rounded-lg border border-white/10 bg-[rgba(28,30,32,0.95)] backdrop-blur-[32px] overflow-hidden"
        >
          {options.map((option) => (
            <button
              key={option}
